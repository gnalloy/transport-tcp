...
- Import path: `gnalloy.org/transport-tcp`
- Repository: `github.com/gnalloy/transport-tcp`
- Default branch: `dev`
- Preview install: `go get gnalloy.org/transport-tcp@dev`
- License: Apache-2.0
...
This repository owns: Native TCP stream transport for Gnalloy, including ServerBootstrap and Dialer integration.
